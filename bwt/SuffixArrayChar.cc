...
class bwt_SuffixArrayChar__closure__7 : public ::x10::lang::Closure {
    ...
    void __apply(){
        ...
        x10_long i__5899max__7937 = ((((((saved_this->FMGL(n)) + (saved_this->FMGL(n0)))) - (saved_this->FMGL(n1)))) - (((x10_long)1ll)));
        {
            x10_long i__7938;
            for (i__7938 = ((x10_long)0ll); ((i__7938) <= (i__5899max__7937));
                 i__7938 = ((i__7938) + (((x10_long)1ll))))
            {
                
                //#line 123 "SuffixArrayChar.x10"
                if ((!::x10aux::struct_equals(((i__7938) % ::x10aux::zeroCheck(((x10_long)3ll))),
                                              ((x10_long)0ll))))
                {
...
class bwt_SuffixArrayChar__closure__8 : public ::x10::lang::Closure {
    ...
    void __apply(){
        x10_long i__5931max__7943 = ((saved_this->FMGL(n02)) - (((x10_long)1ll)));
        {
            x10_long i__7944;
            for (i__7944 = ((x10_long)0ll); ((i__7944) <= (i__5931max__7943));
                 i__7944 = ((i__7944) + (((x10_long)1ll)))) {
                ::x10aux::nullCheck(saved_this->FMGL(R))->x10::lang::Rail< x10_long >::__set(
...
class bwt_SuffixArrayChar__closure__9 : public ::x10::lang::Closure {
    ...
    static x10::lang::Reference* _deserialize(::x10aux::deserialization_buffer &buf) {
        ...
        buf.record_reference(storage);
        ::bwt::SuffixArrayChar* that_saved_this = buf.read< ::bwt::SuffixArrayChar*>();
        x10_long that_i__7951 = buf.read<x10_long>();
        bwt_SuffixArrayChar__closure__9* this_ = new (storage) bwt_SuffixArrayChar__closure__9(that_saved_this, that_i__7951);
        return this_;
    }
    
    bwt_SuffixArrayChar__closure__9(::bwt::SuffixArrayChar* saved_this, x10_long i__7951) : saved_this(saved_this), i__7951(i__7951) { }
...
void bwt::SuffixArrayChar::_constructor(::x10::lang::Rail< x10_byte >* input,
    ...
    ::bwt::SuffixArrayChar* this__7911 = this;
    ::x10aux::nullCheck(this__7911)->FMGL(R) = (::x10aux::class_cast_unchecked< ::x10::lang::Rail< x10_long >*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ::x10aux::nullCheck(this__7911)->FMGL(SA12) = (::x10aux::class_cast_unchecked< ::x10::lang::Rail< x10_long >*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ::x10aux::nullCheck(this__7911)->FMGL(SA) = (::x10aux::class_cast_unchecked< ::x10::lang::Rail< x10_long >*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ::x10aux::nullCheck(this__7911)->FMGL(SA0) = (::x10aux::class_cast_unchecked< ::x10::lang::Rail< x10_long >*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ::x10aux::nullCheck(this__7911)->FMGL(c) = (::x10aux::class_cast_unchecked< ::x10::lang::Rail< x10_long >*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ::x10aux::nullCheck(this__7911)->FMGL(name) = ((x10_long)0ll);
...
void bwt::SuffixArrayChar::radixPass(::x10::lang::Rail< x10_long >* a,
    ...
    x10_long i__5803max__7919 = this->FMGL(k);
    {
        x10_long i__7920;
        for (i__7920 = ((x10_long)0ll); ((i__7920) <= (i__5803max__7919));
             i__7920 = ((i__7920) + (((x10_long)1ll)))) {
            ::x10aux::nullCheck(this->FMGL(c))->x10::lang::Rail< x10_long >::__set(
              i__7920, ((x10_long)0ll));
        }
    }
    
    //#line 45 "SuffixArrayChar.x10"
    x10_long i__5819max__7922 = ((nt) - (((x10_long)1ll)));
    {
        x10_long i__7923;
        for (i__7923 = ((x10_long)0ll); ((i__7923) <= (i__5819max__7922));
             i__7923 = ((i__7923) + (((x10_long)1ll)))) {
            
            //#line 46 "SuffixArrayChar.x10"
            ::x10::lang::Rail< x10_long >* a__7912 = this->FMGL(c);
            x10_long i__7913 = ((x10_long)(::x10aux::nullCheck(this->FMGL(string))->x10::lang::Rail< x10_byte >::__apply(
                                             ((::x10aux::nullCheck(a)->x10::lang::Rail< x10_long >::__apply(
                                                 i__7923)) + (((x10_long)(rOffs)))))));
            x10_long r__7914 = ((::x10aux::nullCheck(a__7912)->x10::lang::Rail< x10_long >::__apply(
                                   i__7913)) + (((x10_long)1ll)));
            ::x10aux::nullCheck(a__7912)->x10::lang::Rail< x10_long >::__set(
              i__7913, r__7914);
        }
    }
    ...
    x10_long i__5835max__7925 = this->FMGL(k);
    {
        x10_long i__7926;
        for (i__7926 = ((x10_long)0ll); ((i__7926) <= (i__5835max__7925));
             i__7926 = ((i__7926) + (((x10_long)1ll)))) {
            
            //#line 50 "SuffixArrayChar.x10"
            x10_long t__7915 = ::x10aux::nullCheck(this->FMGL(c))->x10::lang::Rail< x10_long >::__apply(
                                 i__7926);
    ...
    x10_long i__5851max__7928 = ((nt) - (((x10_long)1ll)));
    {
        x10_long i__7929;
        for (i__7929 = ((x10_long)0ll); ((i__7929) <= (i__5851max__7928));
             i__7929 = ((i__7929) + (((x10_long)1ll)))) {
            ...
            ::x10aux::nullCheck(b)->x10::lang::Rail< x10_long >::__set(
              ::x10aux::nullCheck(this->FMGL(c))->x10::lang::Rail< x10_long >::__apply(
                ((x10_long)(::x10aux::nullCheck(this->FMGL(string))->x10::lang::Rail< x10_byte >::__apply(
                              ((::x10aux::nullCheck(a)->x10::lang::Rail< x10_long >::__apply(
                                  i__7929)) + (((x10_long)(rOffs)))))))),
              ::x10aux::nullCheck(a)->x10::lang::Rail< x10_long >::__apply(
                i__7929));
            
            //#line 56 "SuffixArrayChar.x10"
            ::x10::lang::Rail< x10_long >* a__7916 = this->FMGL(c);
            x10_long i__7917 = ((x10_long)(::x10aux::nullCheck(this->FMGL(string))->x10::lang::Rail< x10_byte >::__apply(
                                             ((::x10aux::nullCheck(a)->x10::lang::Rail< x10_long >::__apply(
                                                 i__7929)) + (((x10_long)(rOffs)))))));
            x10_long r__7918 = ((::x10aux::nullCheck(a__7916)->x10::lang::Rail< x10_long >::__apply(
                                   i__7917)) + (((x10_long)1ll)));
            ::x10aux::nullCheck(a__7916)->x10::lang::Rail< x10_long >::__set(
              i__7917, r__7918);
        }
    }
...
::x10::lang::Rail< x10_long >* bwt::SuffixArrayChar::run(
    ...
    ::x10::io::Console::FMGL(ERR__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((&::bwt::SuffixArrayChar_Strings::sl__8130)));
    ...
    ::x10::io::Console::FMGL(ERR__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((&::bwt::SuffixArrayChar_Strings::sl__8131)));
    ...
    ::x10::io::Console::FMGL(ERR__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((&::bwt::SuffixArrayChar_Strings::sl__8132)));
...
::x10::lang::Rail< x10_long >* bwt::SuffixArrayChar::bwtable(
    ...
    x10_long i__5867max__7931 = ((this->FMGL(n)) - (((x10_long)1ll)));
    {
        x10_long i__7932;
        for (i__7932 = ((x10_long)0ll); ((i__7932) <= (i__5867max__7931));
             i__7932 = ((i__7932) + (((x10_long)1ll)))) {
            
            //#line 86 "SuffixArrayChar.x10"
            if ((!::x10aux::struct_equals(::x10aux::nullCheck(this->FMGL(SA))->x10::lang::Rail< x10_long >::__apply(
                                            i__7932), ((x10_long)0ll))))
            {
...
void bwt::SuffixArrayChar::constructSample() {
    {
        ...
        ::x10::xrx::FinishState* fs__7966 = ::x10::xrx::Runtime::startFinish();
        try {
            {
                ...
                x10_long i__5883max__7934 = ((((((this->FMGL(n)) + (this->FMGL(n0)))) - (this->FMGL(n1)))) - (((x10_long)1ll)));
                {
                    x10_long i__7935;
                    for (i__7935 = ((x10_long)0ll); ((i__7935) <= (i__5883max__7934));
                         i__7935 = ((i__7935) + (((x10_long)1ll))))
                    {
                        
                        //#line 104 "SuffixArrayChar.x10"
                        if ((!::x10aux::struct_equals(((i__7935) % ::x10aux::zeroCheck(((x10_long)3ll))),
                                                      ((x10_long)0ll))))
                        {
            ...
            {
                ::x10::lang::CheckedThrowable* ct__7964 =
                  __exc26;
                {
                    ::x10::xrx::Runtime::pushException(ct__7964);
                }
            }
        }
        ::x10::xrx::Runtime::stopFinish(fs__7966);
    }
}
...
void bwt::SuffixArrayChar::constructSampleR() {
    {
        ...
        ::x10::xrx::Runtime::ensureNotInAtomic();
        ::x10::xrx::FinishState* fs__7974 = ::x10::xrx::Runtime::startFinish();
        try {
            {
            ...
            {
                ::x10::lang::CheckedThrowable* ct__7972 =
                  __exc28;
                {
                    ::x10::xrx::Runtime::pushException(ct__7972);
                }
            }
        }
        ::x10::xrx::Runtime::stopFinish(fs__7974);
    }
    
    //#line 134 "SuffixArrayChar.x10"
    ::x10::io::Console::FMGL(ERR__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((&::bwt::SuffixArrayChar_Strings::sl__8133)));
}
...
void bwt::SuffixArrayChar::sortSample() {
    ...
    x10_long i__5915max__7940 = ((this->FMGL(n02)) - (((x10_long)1ll)));
    {
        x10_long i__7941;
        for (i__7941 = ((x10_long)0ll); ((i__7941) <= (i__5915max__7940));
             i__7941 = ((i__7941) + (((x10_long)1ll)))) {
            ...
            if ((::x10aux::struct_equals(((::x10aux::nullCheck(this->FMGL(SA12))->x10::lang::Rail< x10_long >::__apply(
                                             i__7941)) % ::x10aux::zeroCheck(((x10_long)3ll))),
                                         ((x10_long)1ll))))
            {
                ...
                ::x10aux::nullCheck(this->FMGL(R))->x10::lang::Rail< x10_long >::__set(
                  ((((::x10aux::nullCheck(this->FMGL(SA12))->x10::lang::Rail< x10_long >::__apply(
                        i__7941)) / ::x10aux::zeroCheck(((x10_long)3ll)))) + (this->FMGL(n0))),
                  this->FMGL(name));
            }
    ...
    ::x10::io::Console::FMGL(ERR__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((&::bwt::SuffixArrayChar_Strings::sl__8134)));
}
...
void bwt::SuffixArrayChar::sortNonSample() {
    ...
    if (((this->FMGL(name)) < (this->FMGL(n02)))) {
        ...
        ::x10::io::Console::FMGL(ERR__get)()->x10::io::Printer::println(
          reinterpret_cast< ::x10::lang::Any*>((&::bwt::SuffixArrayChar_Strings::sl__8135)));
        {
            
            //#line 182 "SuffixArrayChar.x10"
            ::x10::xrx::Runtime::ensureNotInAtomic();
            ::x10::xrx::FinishState* fs__7979 = ::x10::xrx::Runtime::startFinish();
            try {
                {
                    ...
                    x10_long i__5947max__7946 = ((this->FMGL(n02)) - (((x10_long)1ll)));
                    {
                        x10_long i__7947;
                        for (i__7947 = ((x10_long)0ll); ((i__7947) <= (i__5947max__7946));
                             i__7947 = ((i__7947) + (((x10_long)1ll))))
                        {
                            
                            //#line 186 "SuffixArrayChar.x10"
                            if (((::x10aux::nullCheck(this->FMGL(SA12))->x10::lang::Rail< x10_long >::__apply(
                                    i__7947)) < (this->FMGL(n0))))
                            {
                    ...
                    ::x10::io::Console::FMGL(ERR__get)()->x10::io::Printer::println(
                      reinterpret_cast< ::x10::lang::Any*>((&::bwt::SuffixArrayChar_Strings::sl__8136)));
                ...
                {
                    ::x10::lang::CheckedThrowable* ct__7977 =
                      __exc31;
                    {
            ...
            ::x10::xrx::Runtime::stopFinish(fs__7979);
        }
    } else {
        {
            ...
            ::x10::xrx::Runtime::ensureNotInAtomic();
            ::x10::xrx::FinishState* fs__7984 = ::x10::xrx::Runtime::startFinish();
            try {
                {
                    x10_long i__5963max__7949 = ((this->FMGL(n02)) - (((x10_long)1ll)));
                    {
                        x10_long i__7950;
                        for (i__7950 = ((x10_long)0ll); ((i__7950) <= (i__5963max__7949));
                             i__7950 = ((i__7950) + (((x10_long)1ll))))
                        {
                            x10_long i__7951 = i__7950;
                            ::x10::xrx::Runtime::runAsync(
                              reinterpret_cast< ::x10::lang::VoidFun_0_0*>((new (::x10aux::alloc< ::x10::lang::VoidFun_0_0>(sizeof(bwt_SuffixArrayChar__closure__9)))bwt_SuffixArrayChar__closure__9(this, i__7951))));
                        }
                    }
                ...
                {
                    ::x10::lang::CheckedThrowable* ct__7982 =
                      __exc32;
                    {
                        ::x10::xrx::Runtime::pushException(
                          ct__7982);
            ...
            ::x10::xrx::Runtime::stopFinish(fs__7984);
        }
        ...
        x10_long i__5979max__7952 = ((this->FMGL(n02)) - (((x10_long)1ll)));
        {
            x10_long i__7953;
            for (i__7953 = ((x10_long)0ll); ((i__7953) <= (i__5979max__7952));
                 i__7953 = ((i__7953) + (((x10_long)1ll))))
            {
                
                //#line 202 "SuffixArrayChar.x10"
                if (((::x10aux::nullCheck(this->FMGL(SA12))->x10::lang::Rail< x10_long >::__apply(
                        i__7953)) < (this->FMGL(n0)))) {
    ...
    ::x10::io::Console::FMGL(ERR__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((&::bwt::SuffixArrayChar_Strings::sl__8137)));
    ...
    while (((k) < (this->FMGL(n)))) {
        ...
        if (((((::x10aux::nullCheck(this->FMGL(SA12))->x10::lang::Rail< x10_long >::__apply(
                ...
                x10_long a__7899 = ((x10_long)(::x10aux::nullCheck(this->FMGL(string))->x10::lang::Rail< x10_byte >::__apply(
                                                 i)));
                x10_long a__7900 = ::x10aux::nullCheck(this->FMGL(R))->x10::lang::Rail< x10_long >::__apply(
                                     ((::x10aux::nullCheck(this->FMGL(SA12))->x10::lang::Rail< x10_long >::__apply(
                                         t)) + (this->FMGL(n0))));
                x10_long b__7901 = ((x10_long)(::x10aux::nullCheck(this->FMGL(string))->x10::lang::Rail< x10_byte >::__apply(
                                                 j)));
                x10_long b__7902 = ::x10aux::nullCheck(this->FMGL(R))->x10::lang::Rail< x10_long >::__apply(
                                     ((j) / ::x10aux::zeroCheck(((x10_long)3ll))));
                (((a__7899) < (b__7901)) || ((::x10aux::struct_equals(a__7899,
                                                                      b__7901)) &&
                ((a__7900) <= (b__7902))));
            }))
            ) || (((::x10aux::nullCheck(this->FMGL(SA12))->x10::lang::Rail< x10_long >::__apply(
                                                      ...
                                                      ((((j) / ::x10aux::zeroCheck(((x10_long)3ll)))) + (this->FMGL(n0))))))))
        {
            ...
            if ((::x10aux::struct_equals(t, this->FMGL(n02))))
            {
                ...
                x10_long i__5995max__7955 = ((((this->FMGL(n0)) - (p))) - (((x10_long)1ll)));
                {
                    x10_long i__7956;
                    for (i__7956 = ((x10_long)0ll); ((i__7956) <= (i__5995max__7955));
                         i__7956 = ((i__7956) + (((x10_long)1ll))))
                    {
            ...
            if ((::x10aux::struct_equals(p, this->FMGL(n0))))
            {
                ...
                x10_long i__6011max__7958 = ((((this->FMGL(n02)) - (t))) - (((x10_long)1ll)));
                {
                    x10_long i__7959;
                    for (i__7959 = ((x10_long)0ll); ((i__7959) <= (i__6011max__7958));
                         i__7959 = ((i__7959) + (((x10_long)1ll))))
                    {
...
::x10::lang::String bwt::SuffixArrayChar_Strings::sl__8132("Start Sort Char NonSample");
::x10::lang::String bwt::SuffixArrayChar_Strings::sl__8131("Start Sort Char Sample");
::x10::lang::String bwt::SuffixArrayChar_Strings::sl__8134("Ended Sort Sample");
::x10::lang::String bwt::SuffixArrayChar_Strings::sl__8135("Ended BWA run");
::x10::lang::String bwt::SuffixArrayChar_Strings::sl__8133("Malloc End");
::x10::lang::String bwt::SuffixArrayChar_Strings::sl__8137("Start Merge Final");
::x10::lang::String bwt::SuffixArrayChar_Strings::sl__8136("Start SortPairs Char");
::x10::lang::String bwt::SuffixArrayChar_Strings::sl__8130("Start Constructuring Char Sample");
