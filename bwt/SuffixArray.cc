...
void bwt::SuffixArray::radixPass(::x10::lang::Rail< x10_long >* a,
    ...
    x10_long i__2467min__2665 = ((x10_long)0ll);
    x10_long i__2467max__2666 = this->FMGL(k);
    {
        x10_long i__2667;
        for (i__2667 = i__2467min__2665; ((i__2667) <= (i__2467max__2666));
             i__2667 = ((i__2667) + (((x10_long)1ll)))) {
            x10_long i__2668 = i__2667;
            ::x10aux::nullCheck(c)->x10::lang::Rail< x10_long >::__set(
              i__2668, ((x10_long)0ll));
        }
    }
    
    //#line 31 "SuffixArray.x10"
    x10_long i__2483min__2669 = ((x10_long)0ll);
    x10_long i__2483max__2670 = ((nt) - (((x10_long)1ll)));
    {
        x10_long i__2671;
        for (i__2671 = i__2483min__2669; ((i__2671) <= (i__2483max__2670));
             i__2671 = ((i__2671) + (((x10_long)1ll)))) {
            x10_long i__2672 = i__2671;
            
            //#line 32 "SuffixArray.x10"
            ::x10::lang::Rail< x10_long >* a__2658 = c;
            x10_long i__2659 = ::x10aux::nullCheck(this->FMGL(string))->x10::lang::Rail< x10_long >::__apply(
                                 ((::x10aux::nullCheck(a)->x10::lang::Rail< x10_long >::__apply(
                                     i__2672)) + (((x10_long)(rOffs)))));
            x10_long r__2660 = ((::x10aux::nullCheck(a__2658)->x10::lang::Rail< x10_long >::__apply(
                                   i__2659)) + (((x10_long)1ll)));
            ::x10aux::nullCheck(a__2658)->x10::lang::Rail< x10_long >::__set(
              i__2659, r__2660);
        }
    }
    ...
    x10_long i__2499min__2673 = ((x10_long)0ll);
    x10_long i__2499max__2674 = this->FMGL(k);
    {
        x10_long i__2675;
        for (i__2675 = i__2499min__2673; ((i__2675) <= (i__2499max__2674));
             i__2675 = ((i__2675) + (((x10_long)1ll)))) {
            x10_long i__2676 = i__2675;
            
            //#line 36 "SuffixArray.x10"
            x10_long t__2661 = ::x10aux::nullCheck(c)->x10::lang::Rail< x10_long >::__apply(
                                 i__2676);
    ...
    x10_long i__2515min__2677 = ((x10_long)0ll);
    x10_long i__2515max__2678 = ((nt) - (((x10_long)1ll)));
    {
        x10_long i__2679;
        for (i__2679 = i__2515min__2677; ((i__2679) <= (i__2515max__2678));
             i__2679 = ((i__2679) + (((x10_long)1ll)))) {
            x10_long i__2680 = i__2679;
            ...
            ::x10aux::nullCheck(b)->x10::lang::Rail< x10_long >::__set(
              ::x10aux::nullCheck(c)->x10::lang::Rail< x10_long >::__apply(
                ::x10aux::nullCheck(this->FMGL(string))->x10::lang::Rail< x10_long >::__apply(
                  ((::x10aux::nullCheck(a)->x10::lang::Rail< x10_long >::__apply(
                      i__2680)) + (((x10_long)(rOffs)))))),
              ::x10aux::nullCheck(a)->x10::lang::Rail< x10_long >::__apply(
                i__2680));
            
            //#line 42 "SuffixArray.x10"
            ::x10::lang::Rail< x10_long >* a__2662 = c;
            x10_long i__2663 = ::x10aux::nullCheck(this->FMGL(string))->x10::lang::Rail< x10_long >::__apply(
                                 ((::x10aux::nullCheck(a)->x10::lang::Rail< x10_long >::__apply(
                                     i__2680)) + (((x10_long)(rOffs)))));
            x10_long r__2664 = ((::x10aux::nullCheck(a__2662)->x10::lang::Rail< x10_long >::__apply(
                                   i__2663)) + (((x10_long)1ll)));
            ::x10aux::nullCheck(a__2662)->x10::lang::Rail< x10_long >::__set(
              i__2663, r__2664);
        }
    }
...
::x10::lang::Rail< x10_long >* bwt::SuffixArray::bwtable(
    ...
    x10_long i__2531min__2681 = ((x10_long)0ll);
    x10_long i__2531max__2682 = ((this->FMGL(n)) - (((x10_long)1ll)));
    {
        x10_long i__2683;
        for (i__2683 = i__2531min__2681; ((i__2683) <= (i__2531max__2682));
             i__2683 = ((i__2683) + (((x10_long)1ll)))) {
            x10_long i__2684 = i__2683;
            
            //#line 56 "SuffixArray.x10"
            if ((!::x10aux::struct_equals(::x10aux::nullCheck(this->FMGL(SA))->x10::lang::Rail< x10_long >::__apply(
                                            i__2684), ((x10_long)0ll))))
            {
...
void bwt::SuffixArray::constructSample() {
    ...
    x10_long i__2547min__2685 = ((x10_long)0ll);
    x10_long i__2547max__2686 = ((((((this->FMGL(n)) + (this->FMGL(n0)))) - (this->FMGL(n1)))) - (((x10_long)1ll)));
    {
        x10_long i__2687;
        for (i__2687 = i__2547min__2685; ((i__2687) <= (i__2547max__2686));
             i__2687 = ((i__2687) + (((x10_long)1ll)))) {
            x10_long i__2688 = i__2687;
            
            //#line 70 "SuffixArray.x10"
            if ((!::x10aux::struct_equals(((i__2688) % ::x10aux::zeroCheck(((x10_long)3ll))),
                                          ((x10_long)0ll))))
            {
...
void bwt::SuffixArray::sortSample() {
    ...
    x10_long i__2563min__2697 = ((x10_long)0ll);
    x10_long i__2563max__2698 = ((this->FMGL(n02)) - (((x10_long)1ll)));
    {
        x10_long i__2699;
        for (i__2699 = i__2563min__2697; ((i__2699) <= (i__2563max__2698));
             i__2699 = ((i__2699) + (((x10_long)1ll)))) {
            x10_long i__2700 = i__2699;
            ...
            if ((::x10aux::struct_equals(((::x10aux::nullCheck(this->FMGL(SA12))->x10::lang::Rail< x10_long >::__apply(
                                             i__2700)) % ::x10aux::zeroCheck(((x10_long)3ll))),
                                         ((x10_long)1ll))))
            {
                ...
                ::x10aux::nullCheck(this->FMGL(R))->x10::lang::Rail< x10_long >::__set(
                  ((((::x10aux::nullCheck(this->FMGL(SA12))->x10::lang::Rail< x10_long >::__apply(
                        i__2700)) / ::x10aux::zeroCheck(((x10_long)3ll)))) + (this->FMGL(n0))),
                  name);
            }
    ...
    if (((name) < (this->FMGL(n02)))) {
        ...
        x10_long i__2579min__2689 = ((x10_long)0ll);
        x10_long i__2579max__2690 = ((this->FMGL(n02)) - (((x10_long)1ll)));
        {
            x10_long i__2691;
            for (i__2691 = i__2579min__2689; ((i__2691) <= (i__2579max__2690));
                 i__2691 = ((i__2691) + (((x10_long)1ll))))
            {
                x10_long i__2692 = i__2691;
                ::x10aux::nullCheck(this->FMGL(R))->x10::lang::Rail< x10_long >::__set(
                  ::x10aux::nullCheck(this->FMGL(SA12))->x10::lang::Rail< x10_long >::__apply(
        ...
        x10_long i__2595min__2693 = ((x10_long)0ll);
        x10_long i__2595max__2694 = ((this->FMGL(n02)) - (((x10_long)1ll)));
        {
            x10_long i__2695;
            for (i__2695 = i__2595min__2693; ((i__2695) <= (i__2595max__2694));
                 i__2695 = ((i__2695) + (((x10_long)1ll))))
            {
                x10_long i__2696 = i__2695;
                ::x10aux::nullCheck(this->FMGL(SA12))->x10::lang::Rail< x10_long >::__set(
                  ((::x10aux::nullCheck(this->FMGL(R))->x10::lang::Rail< x10_long >::__apply(
                      i__2696)) - (((x10_long)1ll))), i__2696);
            }
        }
...
void bwt::SuffixArray::sortNonSample() {
    ...
    x10_long i__2611min__2709 = ((x10_long)0ll);
    x10_long i__2611max__2710 = ((this->FMGL(n02)) - (((x10_long)1ll)));
    {
        x10_long i__2711;
        for (i__2711 = i__2611min__2709; ((i__2711) <= (i__2611max__2710));
             i__2711 = ((i__2711) + (((x10_long)1ll)))) {
            x10_long i__2712 = i__2711;
            
            //#line 117 "SuffixArray.x10"
            if (((::x10aux::nullCheck(this->FMGL(SA12))->x10::lang::Rail< x10_long >::__apply(
                    i__2712)) < (this->FMGL(n0)))) {
    ...
    while (((k) < (this->FMGL(n)))) {
                                                         ...
                                                         ((((j) / ::x10aux::zeroCheck(((x10_long)3ll)))) + (this->FMGL(n0))))))))
        {
            ...
            if ((::x10aux::struct_equals(t, this->FMGL(n02))))
            {
                ...
                x10_long i__2627min__2701 = ((x10_long)0ll);
                x10_long i__2627max__2702 = ((((this->FMGL(n0)) - (p))) - (((x10_long)1ll)));
                {
                    x10_long i__2703;
                    for (i__2703 = i__2627min__2701; ((i__2703) <= (i__2627max__2702));
                         i__2703 = ((i__2703) + (((x10_long)1ll))))
                    {
                        x10_long q__2704 = i__2703;
            ...
            if ((::x10aux::struct_equals(p, this->FMGL(n0))))
            {
                ...
                x10_long i__2643min__2705 = ((x10_long)0ll);
                x10_long i__2643max__2706 = ((((this->FMGL(n02)) - (t))) - (((x10_long)1ll)));
                {
                    x10_long i__2707;
                    for (i__2707 = i__2643min__2705; ((i__2707) <= (i__2643max__2706));
                         i__2707 = ((i__2707) + (((x10_long)1ll))))
                    {
                        x10_long q__2708 = i__2707;
